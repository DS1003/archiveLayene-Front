...
const Home = () => {
    ...
    const user = {
        name: "John Doe",
        credit: 500,  // Exemple de crédit utilisateur statique
    };
    const [isSidebarOpen, setIsSidebarOpen] = useState(false);
    const [isRightElementsOpen, setIsRightElementsOpen] = useState(false);
    const [balance, setBalance] = useState(500); // Balance statique
        ...
        <div className="flex h-screen overflow-hidden">
            ...
            <div className="hidden-scrollbar flex-1 overflow-y-auto lg:ml-[calc(25%+5%)] lg:mr-[27%] mt-[3.5%] p-6">
                <div className="max-w-2xl mx-auto">
                    ...
                    <CreatePostCard user={user} onPostCreate={handlePostCreationAnUpdateBalance} />
                    <Post user={user} />
